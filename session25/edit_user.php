          ...
          <div class="box box-primary">
            ...
            <form role="form" action="#" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label>
                    <input type="radio" name="gender" class="minimal" value="male" <?php if ($editUserDetail['gender'] === 'male') echo "checked='checked'";?>>Male
                  </label>
                  <label>
                    <input type="radio" name="gender" class="minimal" value="female" <?php if ($editUserDetail['gender'] === 'female') echo "checked";?>>Female
                  </label>
                  <label>
                    <input type="radio" name="gender" class="minimal" value="other" <?php if ($editUserDetail['gender'] === 'other') echo "checked";?>>Other
                </div>
              </div>
              <div class="form-group">
                <label>City</label>
